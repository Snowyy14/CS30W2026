 ...
 *              of division. Implements Comparable so I can compare pucks by weight.
...
public class Puck extends Disk implements Comparable<Puck> {
    ...
    /**
     * Returns the division this puck belongs to based on its weight.
     ...
     * I round to 1 decimal since puck weights are usually measured that way.
     * pre: none
